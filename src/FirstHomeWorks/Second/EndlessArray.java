...
public class EndlessArray<T> implements Inter<T> {
     ...
     */
    public EndlessArray() throws IOExeption {
        this(INITIAL_SIZE);
    }
     ...
     * @throws IOExeption if the specified initial capacity is negative
     */
    public EndlessArray(int capacity) throws IOExeption {
        if (capacity < 0) {
    ...
    private boolean compareArrays(EndlessArray firstArr){
